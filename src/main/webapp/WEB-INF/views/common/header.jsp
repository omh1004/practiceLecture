  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="#">
        <img alt="로고" src="${pageContext.request.contextPath}/resources/images/logo-spring.png"
             width="50px">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul	class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="${path}/memo/memolist.do">메모</a>
          </li>
          <li class="nav-item active">
        ...
        <c:if test="${loginMember!=null}">
          ...
          <button class="btn btn-outline-dark" onclick="openChatting();"></button>
          &nbsp
          <button class="btn btn-outline-danger" onclick="location.replace('${pageContext.request.contextPath}/member/logout.do')">
            로그아웃
          </button>
        </c:if>
